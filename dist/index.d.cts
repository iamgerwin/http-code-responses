...
type StatusCode = typeof StatusCodes[StatusName];
declare const ReasonPhrases: Record<number, string>;
declare function getReasonPhrase(code: number): string | undefined;
declare function getStatusCode(name: StatusName | string): number | undefined;
...
declare const _default: {
    ...
    getReasonPhrase: typeof getReasonPhrase;
    getStatusCode: typeof getStatusCode;
    isStatusCode: typeof isStatusCode;
};

export { ReasonPhrases, type StatusCode, StatusCodes, type StatusName, _default as default, getReasonPhrase, getStatusCode, isStatusCode };
